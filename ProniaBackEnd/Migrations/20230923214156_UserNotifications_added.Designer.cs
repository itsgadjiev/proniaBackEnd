...
namespace ProniaBackEnd.Migrations
{
    ...
    [Migration("20230923214156_UserNotifications_added")]
    partial class UserNotifications_added
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProniaBackEnd.Database.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ProniaBackEnd.Database.Models.UserNotification", b =>
                {
            ...
            modelBuilder.Entity("ProniaBackEnd.Database.Models.UserNotification", b =>
                {
                    b.HasOne("ProniaBackEnd.Database.Models.Notification", "Notification")
                        .WithMany("UserNotifications")
                        .HasForeignKey("NotificationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProniaBackEnd.Database.Models.User", "RecievingUser")
                        .WithMany("UserNotificationsReceived")
                        .HasForeignKey("RecievingUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProniaBackEnd.Database.Models.User", "SendingUser")
