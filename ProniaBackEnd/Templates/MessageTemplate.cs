...
namespace ProniaBackEnd.Templates
{
    public class MessageTemplate
    {
        ...
        public const string COMPLETED_ORDER_AZ = $" Hörmətli {OrderMessageTemplateKeywords.FIRSTNAME} {OrderMessageTemplateKeywords.LASTNAME}, sizin {OrderMessageTemplateKeywords.ORDER_NUMBER} kuryer tərəfindən təhvil verildi.";
